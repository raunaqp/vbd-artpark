...
const odishaRoles: RoleInfo[] = [
  ...
  { id: "od_d_bal", stateId: "odisha", label: "District — Baleshwar", scope: "district", location: "Baleshwar", roleName: "DHO", userName: "A. Sahu", district: "Baleshwar" },
  ...
  { id: "od_b_nil", stateId: "odisha", label: "Block — Nilgiri", scope: "block", location: "Nilgiri", roleName: "Block Worker", userName: "J. Nayak", district: "Baleshwar", block: "Nilgiri" },
