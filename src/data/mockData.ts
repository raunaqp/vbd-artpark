...
const ODISHA: StateBundle = {
  ...
  districts: ["All Districts", "Khordha", "Cuttack", "Puri", "Angul", "Baleshwar", "Ganjam", "Sambalpur", "Sundargarh"],
  blocks: ["All Blocks", "Brahmagiri", "Talcher", "Nilgiri", "Bhubaneswar MC", "Cuttack MC", "Puri MC", "Rourkela MC", "Sambalpur MC"],
  regionData: [
    { name: "Baleshwar", suspected: 720, tested: 680, confirmed: 95, risk: "high", trend: "up", type: "district" },
    { name: "Khordha", suspected: 540, tested: 510, confirmed: 58, risk: "high", trend: "up", type: "district" },
  ...
  subDistrictData: [
    { name: "Nilgiri", suspected: 220, tested: 205, confirmed: 35, risk: "high", trend: "up", type: "block", parentDistrict: "Baleshwar" },
    { name: "Soro", suspected: 180, tested: 168, confirmed: 28, risk: "high", trend: "up", type: "block", parentDistrict: "Baleshwar" },
    { name: "Baleshwar Sadar", suspected: 160, tested: 150, confirmed: 22, risk: "high", trend: "up", type: "block", parentDistrict: "Baleshwar" },
    { name: "Basta", suspected: 90, tested: 85, confirmed: 10, risk: "moderate", trend: "stable", type: "block", parentDistrict: "Baleshwar" },
    { name: "Bhubaneswar MC", suspected: 280, tested: 265, confirmed: 32, risk: "high", trend: "up", type: "municipality", parentDistrict: "Khordha" },
    { name: "Jatni", suspected: 110, tested: 102, confirmed: 12, risk: "moderate", trend: "stable", type: "block", parentDistrict: "Khordha" },
    { name: "Banapur", suspected: 80, tested: 75, confirmed: 8, risk: "moderate", trend: "stable", type: "block", parentDistrict: "Khordha" },
    { name: "Begunia", suspected: 60, tested: 56, confirmed: 5, risk: "low", trend: "down", type: "block", parentDistrict: "Khordha" },
  ...
  villageData: [
    { name: "Nilgiri Town", suspected: 80, tested: 75, confirmed: 14, risk: "high", trend: "up", type: "village", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { name: "Oupada", suspected: 60, tested: 56, confirmed: 10, risk: "high", trend: "up", type: "village", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { name: "Berhampur Sasan", suspected: 45, tested: 42, confirmed: 6, risk: "moderate", trend: "up", type: "village", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { name: "Kuamara", suspected: 30, tested: 28, confirmed: 3, risk: "low", trend: "stable", type: "village", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
  ...
  wardData: [
    { name: "Old Town", suspected: 70, tested: 66, confirmed: 10, risk: "high", trend: "up", type: "ward", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { name: "Saheed Nagar", suspected: 55, tested: 52, confirmed: 8, risk: "high", trend: "up", type: "ward", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { name: "Patia", suspected: 45, tested: 42, confirmed: 6, risk: "moderate", trend: "stable", type: "ward", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { name: "Chandrasekharpur", suspected: 35, tested: 32, confirmed: 4, risk: "moderate", trend: "stable", type: "ward", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
  ...
  statePredictions: [
    { area: "Baleshwar", probability: 88, risk: "high", expectedWeek: "W+2", signal: "Highest case load in state — sustained rise (180→240→310→420 in last 4 weeks)" },
    ...
    { area: "Khordha", probability: 75, risk: "high", expectedWeek: "W+2", signal: "Urban clustering in Bhubaneswar + drainage-linked breeding" },
  ...
  districtPredictions: [
    { area: "Nilgiri", probability: 90, risk: "high", expectedWeek: "W+2", signal: "Sharpest rise in state — fever cases doubling weekly + ASHA cluster reports", parentDistrict: "Baleshwar", areaType: "Block" },
    { area: "Soro", probability: 78, risk: "high", expectedWeek: "W+2", signal: "Sustained case rise + breeding sites confirmed in field surveys", parentDistrict: "Baleshwar", areaType: "Block" },
    { area: "Baleshwar Sadar", probability: 72, risk: "high", expectedWeek: "W+3", signal: "Urban-periphery clustering + OPD spike at district hospital", parentDistrict: "Baleshwar", areaType: "Block" },
    { area: "Basta", probability: 45, risk: "moderate", expectedWeek: "W+3", signal: "Moderate baseline + climate favourable", parentDistrict: "Baleshwar", areaType: "Block" },
    { area: "Bhubaneswar MC", probability: 84, risk: "high", expectedWeek: "W+2", signal: "Dense urban wards (Old Town, Saheed Nagar) + drainage-linked breeding", parentDistrict: "Khordha", areaType: "Municipality" },
    { area: "Jatni", probability: 50, risk: "moderate", expectedWeek: "W+3", signal: "Peri-urban density + historical April pattern", parentDistrict: "Khordha", areaType: "Block" },
    { area: "Banapur", probability: 38, risk: "moderate", expectedWeek: "W+4", signal: "Moderate climate trigger + low baseline", parentDistrict: "Khordha", areaType: "Block" },
    { area: "Begunia", probability: 18, risk: "low", expectedWeek: "W+4", signal: "Declining cases", parentDistrict: "Khordha", areaType: "Block" },
  ...
  blockPredictions: [
    { area: "Nilgiri Town", probability: 92, risk: "high", expectedWeek: "W+2", signal: "Sharp rise in fever cases — village-level cluster confirmed", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { area: "Oupada", probability: 80, risk: "high", expectedWeek: "W+2", signal: "Breeding sites confirmed in field surveys + ASHA cluster reports", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { area: "Berhampur Sasan", probability: 60, risk: "moderate", expectedWeek: "W+3", signal: "Moderate rise + favourable climate", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { area: "Kuamara", probability: 25, risk: "low", expectedWeek: "W+4", signal: "Stable baseline", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
  ...
  municipalityPredictions: [
    { area: "Old Town", probability: 88, risk: "high", expectedWeek: "W+2", signal: "Dense ward + heritage-area drainage issues + waterlogging", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { area: "Saheed Nagar", probability: 75, risk: "high", expectedWeek: "W+2", signal: "Commercial-zone clustering + construction debris", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { area: "Patia", probability: 50, risk: "moderate", expectedWeek: "W+3", signal: "IT-corridor density + moderate baseline", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { area: "Chandrasekharpur", probability: 40, risk: "moderate", expectedWeek: "W+4", signal: "Residential density + climate favourable", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
  ...
  hotspotDistrictData: [
    { area: "Baleshwar", currentCases: 95, prevCases: 62, trend: "up", risk: "high" },
    { area: "Khordha", currentCases: 58, prevCases: 42, trend: "up", risk: "high" },
  ...
  hotspotSubDistrictData: [
    { area: "Nilgiri", currentCases: 35, prevCases: 18, trend: "up", risk: "high", parentDistrict: "Baleshwar" },
    { area: "Soro", currentCases: 28, prevCases: 16, trend: "up", risk: "high", parentDistrict: "Baleshwar" },
    { area: "Baleshwar Sadar", currentCases: 22, prevCases: 14, trend: "up", risk: "high", parentDistrict: "Baleshwar" },
    { area: "Bhubaneswar MC", currentCases: 32, prevCases: 22, trend: "up", risk: "high", parentDistrict: "Khordha" },
    { area: "Jatni", currentCases: 12, prevCases: 10, trend: "stable", risk: "moderate", parentDistrict: "Khordha" },
  ...
  hotspotVillageData: [
    { area: "Nilgiri Town", currentCases: 14, prevCases: 6, trend: "up", risk: "high", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { area: "Oupada", currentCases: 10, prevCases: 5, trend: "up", risk: "high", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    { area: "Berhampur Sasan", currentCases: 6, prevCases: 4, trend: "up", risk: "moderate", parentDistrict: "Baleshwar", parentBlock: "Nilgiri" },
    ...
    { area: "Old Town", currentCases: 10, prevCases: 5, trend: "up", risk: "high", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { area: "Saheed Nagar", currentCases: 8, prevCases: 5, trend: "up", risk: "high", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
    { area: "Patia", currentCases: 6, prevCases: 5, trend: "stable", risk: "moderate", parentDistrict: "Khordha", parentBlock: "Bhubaneswar MC" },
  ...
  hotspotAlerts: [
    { id: 1, district: "Baleshwar", message: "High case load observed in Baleshwar — sustained rise across Nilgiri & Soro blocks", severity: "high" },
    { id: 2, district: "Sundargarh", message: "Industrial worker clustering in Sundargarh — Chhend & Panposh wards (Rourkela)", severity: "high" },
    { id: 3, district: "Khordha", message: "Urban clustering in Bhubaneswar Old Town — drainage-linked breeding suspected", severity: "high" },
  ...
  newsAlerts: [
    { id: 1, headline: "Baleshwar reports sharp rise in fever cases — health teams deployed", source: "OdishaTV", date: "2026-04-10", district: "Baleshwar", severity: "high" },
    ...
    { id: 3, headline: "Bhubaneswar Old Town drainage issues drive urban dengue clustering", source: "The Pioneer", date: "2026-04-08", district: "Khordha", severity: "high" },
  ...
  geoTaggedAlerts: [
    { id: 1, lat: 21.50, lng: 86.93, message: "Cluster of fever cases in Nilgiri block villages", district: "Baleshwar", severity: "high" },
    { id: 2, lat: 22.22, lng: 84.86, message: "Industrial worker clustering — Chhend & Panposh wards", district: "Sundargarh", severity: "high" },
    { id: 3, lat: 20.27, lng: 85.84, message: "Old Town drainage hotspot + urban clustering", district: "Khordha", severity: "high" },
...
function generateDailyTimeSeries(profile: TemporalProfile, window: DashboardDateWindow, scopeScale: number, seedKey: string, filters?: DashboardFiltersLike): TimeSeriesPoint[] {
  ...
  const seedDaily = filters
    ...
    : undefined;
  const selectedBaseConfirmed = filters ? getSelectedBaseConfirmed(S(), filters) : 0;
